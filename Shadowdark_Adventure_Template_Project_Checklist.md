...
- [ ] Decide this project’s **distribution model** (personal use only, free community release, paid DriveThru/itch, etc.); requirements differ by channel.
...
## 4. Copyright-safe content patterns
...
2. Toolchain decision and minimal “hello PDF” from Markdown (section 2).  
3. First pass at the Markdown template skeleton (section 3).  
4. Pilot adventure + PDF test (section 5).  
5. Tighten legal placeholders and README links (sections 4 and 6).
